  ...
  <div class="records-page">
    <div class="records-header">
      ...
      <el-button type="primary" @click="$router.push('/upload')">
        ...
        <span class="btn-text">新记录</span></el-button>
    </div>
    <div class="records-container" v-loading="loading">
      <div class="search-bar">
        <div class="search-wrapper">
          ...
          <el-input v-model="queryForm.tags" placeholder="搜索标签..." class="search-input" clearable
      ...
      <div class="records-grid">
        <el-card v-for="record in records" :key="record.id" class="record-item" shadow="hover"
          ...
          <div class="record-actions" @click.stop>
            ...
            <el-button class="btn-delete" size="small" @click.stop="confirmDelete(record.id)">
              <el-icon>
                <Delete/>
              </el-icon>
              删除
...
const updateDialogWidth = () => {
  dialogWidth.value = window.innerWidth <= 768 ? "90%" : "700px"
}
updateDialogWidth()
onMounted(() => {
...
const loadRecords = async () => {
  loading.value = true;
  try {
    records.value = await getRecords(queryForm.value)
  } catch (e) {
  } finally {
    loading.value = false
  }
...
const getExcerpt = t => {
  if (!t) return "";
  return t.substring(0, 100) + (t.length > 100 ? "..." : "")
}
